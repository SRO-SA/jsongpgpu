#ifndef JSON_STRING_SCANNER_H
#define JSON_STRING_SCANNER_H
...
public:
  simdjson_really_inline json_string_block next(const simd8x64<uint8_t>& in);
...
//
simdjson_really_inline json_string_block json_string_scanner::next(const simd8x64<uint8_t>& in) {
...
simdjson_really_inline error_code json_string_scanner::finish() {
  if (prev_in_string) {
    return error_code::UNCLOSED_STRING;
  }
